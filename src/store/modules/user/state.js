  ...
  info: {
    ...
    job: [
      ...
      },
      {
        ...
        attrs: {
          post: { desc: '职位名称', value: '小程序开发' },
          department: { desc: '所在部门', value: '运营' },
        },
        location: { desc: '所在城市', value: '上海' },
        desc:
          '<p>背单词小程序（测试项目） 独立开发&nbsp;&nbsp;</p><p>基本功能：辅助中学生背颂中考单词、周期复习</p><p>技术栈： 原生小程序、westore、flask、 nginx</p>',
        update: new Date(),
      },
    ],
    project: [
      ...
      },
      {
        ...
        timespan: { start: '2020年10月', end: '2021年1月' },
        attrs: {
          post: { desc: '担任角色', value: '' },
        },
        location: { desc: '所在城市', value: '上海' },
        desc:
          '<p>基本功能： 简历编辑、按模块存档、简历打印下载、邮件推送、</p><p>技术栈：</p><ul><li>前端：vue、element-ui、 jspdf</li><li>后端：node、mongoose、koa、nginx</li><li>登录模块：oauth2、jwt</li></ul><p>遇到的问题：&nbsp;</p><ul><li>html2canvas渲染出的pdf简历字体分辨率过低</li><li>简历随窗口大小变化进行对应的缩放</li><li>...</li></ul><p>拙劣的应对方法:</p><ul><li>结合jspdf的context2d模块混合渲染, jspdf不直接支持utf8，中文字体需自行注册字体， 部分标签样式渲染有误差，如li</li><li>监听简历元素的右边距，&nbsp;填写表单及窗口放大时按比例缩放简历</li></ul><p><br></p>        ',
        update: new Date(),
      },
    ],
    edu: [
