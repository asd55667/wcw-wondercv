  ...
  <div class="loggin-wrapper pr">
    <div class="box pa">
      ...
      <div class="content">
        <div class="head pr">
          ...
          <div class="toggerOption txt-center">
            <div
              ...
              @click="reloadQcode(true)"
            >
              我是求职者
            </div>
            <div
              :class="`option ${isEmployee ? '' : 'active'}`"
              @click="reloadQcode(false)"
            >
              我是招聘者
            </div>
          </div>
        ...
        <el-form v-if="!isWxLogin" class="formBox" :model="phoneForm">
          <div class="item fcenter">
            <!-- <div class="phone">+86</div> -->
            <div class="pr flex1">
              <el-form-item>
                <el-input
                  v-model="phoneForm.no"
          ...
          <div class="item fcenter">
            <div class="pr flex1">
              <el-form-item>
                <el-input
                  v-model="phoneForm.valCode"
                  placeholder="请输入验证码"
                ></el-input>
              </el-form-item>
            </div>
            <div class="val-code txt-center">
              <span @click="getValCode">发送验证码</span>
            </div>
          </div>
          <button class="submit txt-center">登录</button>
        </el-form>
