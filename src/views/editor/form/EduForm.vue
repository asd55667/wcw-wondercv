<template>
  <div class="edu-wrap">
    <base-form>
      <div slot="head-name" class="head-name">教育经历</div>
      <div slot="form-content">
        <el-form :model="staticValidateForm">
          ...
          <el-form-item prop="name" label="职位名称">
            <el-input v-model="staticValidateForm.post"></el-input>
          </el-form-item>
          <div class="form-wrap">
            <el-form-item class="item" prop="phone" label="所在部门">
              <el-input v-model="staticValidateForm.phone"></el-input>
            </el-form-item>
            <el-form-item class="item" prop="email" label="所在城市">
              <el-input v-model="staticValidateForm.email"></el-input>
            </el-form-item>
            <el-form-item class="item" prop="timespan.start" label="起始时间">
              <el-input v-model="staticValidateForm.timespan.start"></el-input>
            </el-form-item>
            <el-form-item class="item" prop="timespan.end" label="结束时间">
              <el-input v-model="staticValidateForm.timespan.end"></el-input>
            </el-form-item>
          </div>
          <el-form-item prop="desc">
            <div>经历描述</div>
            <quill-editor v-model="staticValidateForm.desc"></quill-editor>
          </el-form-item>
        </el-form>
      </div>
    </base-form>
